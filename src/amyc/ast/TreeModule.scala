...
object NominalTreeModule extends TreeModule {
  ...
  case class Call(qname: QualifiedName, args: List[(Option[Name],Expr)]) extends Expr
  ...
  case class ParamDef(name: Name, tt: TypeTree, value: Option[Expr]) extends Definition
